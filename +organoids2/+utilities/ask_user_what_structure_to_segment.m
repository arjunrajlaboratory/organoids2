function structure_to_segment = ask_user_what_structure_to_segment
    ...
    % list of structures:
    list_structures = {'nuclei_XY_guess', 'nuclei_XY_final', 'nuclei_XZ_guess', 'nuclei_XZ_final', 'nuclei_final_3D', 'lumens_guess', 'lumens_final', 'organoid_guess', 'organoid_final', 'buds_guess', 'buds_final'};
